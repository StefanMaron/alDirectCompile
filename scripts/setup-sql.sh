...
# Import license from artifacts
echo "Importing license..."
docker cp "artifacts/onprem/27.5.46862.0/w1/database/Cronus.bclicense" aldirectcompile-sql-1:/tmp/Cronus.bclicense
$SQLCMD_DB -Q "
...
# Password hash generated by BC's CryptographyHelper algorithm:
# PBKDF2(PBKDF2(password, Guid.Empty, 1, SHA256, 16) + "-V3", userGuid, 100000, SHA256, 16) + "-V3"
